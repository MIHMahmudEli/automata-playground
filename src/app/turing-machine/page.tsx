      ...
      <div className="pt-20 sm:pt-24 pb-10 sm:pb-12 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-gray-300 text-base sm:text-lg max-w-3xl mx-auto px-2 sm:px-0">Design and visualize Turing Machines — the universal model of computation</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="bg-white/5 rounded-xl border border-white/10 relative h-[250px] sm:h-[350px] md:h-[400px]" id="tm-graph-container" ref={containerRef}>
                {!generated && (
