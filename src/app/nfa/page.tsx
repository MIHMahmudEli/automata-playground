      ...
      <div className="pt-24 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg max-w-3xl mx-auto">Create, visualize, and test NFAs with our interactive workspace</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="bg-white/5 rounded-xl border border-white/10 relative h-[400px]" id="nfa-graph-container" ref={containerRef}>
                {!generated && (
